...
<div class="col two-col">
	<div class="col-1">
		...
		<p style="font-size: 1.2em;"><?php _e( 'Thanks for using the Gateway theme! This info page should help you get started or serve as a handy reference area.', 'gateway' ); ?></p>
